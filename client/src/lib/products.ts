...
export const products: Product[] = [
  {
    ...
    description: 'Nossa solução básica de automação para apostas online. Funciona com os principais cassinos de Angola. Ideal para iniciantes que desejam experimentar a automação de apostas.',
    casino: 'Elephant Bet',
